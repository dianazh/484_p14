-- Test sort merge join with two relations having the same length
...
INSERT INTO DDA (serial, ikey, filler, dkey, unq) VALUES (1, 13, '00000 string record',  0.0, 3);

INSERT INTO DDA (serial, ikey, filler, dkey, unq) VALUES (2, 10, '00000 string record',  0.0, 4);
INSERT INTO DDA (serial, ikey, filler, dkey, unq) VALUES (2, 11, '00000 string record',  0.0, 5);
INSERT INTO DDA (serial, ikey, filler, dkey, unq) VALUES (2, 12, '00000 string record',  0.0, 6);
INSERT INTO DDA (serial, ikey, filler, dkey, unq) VALUES (2, 13, '00000 string record',  0.0, 7);
...
INSERT INTO DDA (serial, ikey, filler, dkey, unq) VALUES (3, 12, '00000 string record',  0.0, 10);
