...
SELECT table4.ikey, table4.skey, table4.dkey FROM table4 WHERE table4.dkey < 3;
SELECT table4.dkey, table4.ikey, table4.skey FROM table4 WHERE table4.skey < 'abcd3';
...
SELECT table4.skey, table4.ikey FROM table4 WHERE table4.dkey >= 3;
SELECT table4.skey, table4.dkey FROM table4 WHERE table4.skey >= 'abcd3';
SELECT table4.ikey FROM table4 WHERE table4.ikey > 3;
SELECT table4.ikey FROM table4 WHERE table4.dkey > 3;
SELECT table4.dkey FROM table4 WHERE table4.skey > 'abcd3';
SELECT table4.dkey FROM table4 WHERE table4.ikey <> 3;
SELECT table4.skey FROM table4 WHERE table4.dkey <> 3;
